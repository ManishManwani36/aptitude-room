...
**80 original questions**, 20 in each of the four classic families, with a fully worked solution for every one.
...
| Section | Count | Format | Diagrams |
|---|---|---|---|
| **Numerical Reasoning** | 20 | Multi-step data interpretation (percentages, ratios, CAGR, currency-with-fees, weighted margins, break-even, index numbers, variance) | SVG bar / grouped / stacked / line / pie charts + data tables |
| **Verbal Reasoning** | 20 | Dense passages judged True / False / Cannot Say, plus critical-reasoning MCQs (assumption / inference / strengthen-weaken) | — |
| **Inductive Reasoning** | 20 | Abstract-shape sequences, 3×3 matrices, odd-one-out and analogies — many with two rules at once | SVG figures, generated by a rule engine |
...
6. **Browser verification** — Playwright drives the real app in Chrome through every flow (study, timed quiz with auto-submit, results, answer key, dark mode, mobile); 39 functional + UI checks pass with no console errors.
